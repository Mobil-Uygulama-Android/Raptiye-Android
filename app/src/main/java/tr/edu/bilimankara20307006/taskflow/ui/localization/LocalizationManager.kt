...
class LocalizationManager(context: Context) : ViewModel() {
    ...
    private fun getTurkishString(key: String): String {
        return when (key) {
            ...
            "AddTeamMemberToProject" -> "Projeye Ekip Üyesi Ekle"
            ...
            "Success" -> "Başarılı"
            "MemberAddedSuccessfully" -> "Ekip üyesi başarıyla eklendi"
            "Error" -> "Hata"
            "OK" -> "Tamam"
    ...
    private fun getEnglishString(key: String): String {
        return when (key) {
            ...
            "Success" -> "Success"
            "MemberAddedSuccessfully" -> "Team member added successfully"
            "Error" -> "Error"
            "OK" -> "OK"
